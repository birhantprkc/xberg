...
<!-- alef:hash:53a8ecb680407292d1dae0ee47dfe1051b8ac3777ab92de4031fb39a5aa0cc8b -->
...
```toml
[dependencies]
xberg = { version = "1.2.3", features = ["pdf", "excel", "ocr"] }
```
...
```toml
xberg = { version = "1.2.3", features = ["full"] }
xberg = { version = "1.2.3", features = ["server"] }
xberg = { version = "1.2.3", features = ["cli"] }
```
...
```toml
[dependencies]
xberg = { version = "1.2.3", features = ["pdf"] }
```
