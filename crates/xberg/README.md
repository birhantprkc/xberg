...
<!-- alef:hash:552b5822da0d5b15c6400bb4b2ec4939ca5793196eeaef2beb47ad03702d205e -->
...
```toml
[dependencies]
xberg = { version = "1.2.0", features = ["pdf", "excel", "ocr"] }
```
...
```toml
xberg = { version = "1.2.0", features = ["full"] }
xberg = { version = "1.2.0", features = ["server"] }
xberg = { version = "1.2.0", features = ["cli"] }
```
...
```toml
[dependencies]
xberg = { version = "1.2.0", features = ["pdf"] }
```
