...
<!-- alef:hash:3041bc57f33a55c5d3c96166094f399657ca82177ce8777b60980ebe0d40b815 -->
...
```toml
[dependencies]
xberg = { version = "1.2.2", features = ["pdf", "excel", "ocr"] }
```
...
```toml
xberg = { version = "1.2.2", features = ["full"] }
xberg = { version = "1.2.2", features = ["server"] }
xberg = { version = "1.2.2", features = ["cli"] }
```
...
```toml
[dependencies]
xberg = { version = "1.2.2", features = ["pdf"] }
```
