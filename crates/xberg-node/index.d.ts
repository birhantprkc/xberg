...
// alef:hash:e4074ae8d6f983035985c21ade6c9f16693e26493b08c90fe7bbcb68432a2751
...
export type FormatMetadata =
  | ({ format_type: "pdf" } & __AlefWirePdfMetadata)
  | ({ format_type: "docx" } & __AlefWireDocxMetadata)
  | ({ format_type: "excel" } & __AlefWireExcelMetadata)
  | ({ format_type: "email" } & __AlefWireEmailMetadata)
  | ({ format_type: "pptx" } & __AlefWirePptxMetadata)
  | ({ format_type: "archive" } & __AlefWireArchiveMetadata)
  | ({ format_type: "image" } & __AlefWireImageMetadata)
  | ({ format_type: "xml" } & __AlefWireXmlMetadata)
  | ({ format_type: "text" } & __AlefWireTextMetadata)
  | ({ format_type: "html" } & __AlefWireHtmlMetadata)
  | ({ format_type: "ocr" } & __AlefWireOcrMetadata)
  | ({ format_type: "csv" } & __AlefWireCsvMetadata)
  | ({ format_type: "bibtex" } & __AlefWireBibtexMetadata)
  | ({ format_type: "citation" } & __AlefWireCitationMetadata)
  | ({ format_type: "fiction_book" } & __AlefWireFictionBookMetadata)
  | ({ format_type: "dbf" } & __AlefWireDbfMetadata)
  | ({ format_type: "jats" } & __AlefWireJatsMetadata)
  | ({ format_type: "epub" } & __AlefWireEpubMetadata)
  | ({ format_type: "pst" } & __AlefWirePstMetadata)
  | ({ format_type: "audio" } & __AlefWireAudioMetadata)
  | ({ format_type: "code" } & __AlefWireCodeMetadata);
...
export type __AlefWirePdfMetadata = {
  ...
  scanned_pages?: Array<number> | null;
  layout_gated_pages?: Array<number> | null;
  layout_gate_reasons?: Array<string> | null;
};
export type __AlefWireCoreProperties = {
  title?: string | null;
  subject?: string | null;
  creator?: string | null;
...
export type __AlefWireDocxAppProperties = {
  ...
  company?: string | null;
  doc_security?: number | null;
  scale_crop?: boolean | null;
  links_up_to_date?: boolean | null;
  shared_doc?: boolean | null;
  hyperlinks_changed?: boolean | null;
};
export type __AlefWireDocxMetadata = {
  core_properties?: __AlefWireCoreProperties | null;
  app_properties?: __AlefWireDocxAppProperties | null;
  custom_properties?: Record<string, JsonValue> | null;
};
export type __AlefWireExcelMetadata = { sheet_count?: number | null; sheet_names?: Array<string> | null };
export type __AlefWireEmailMetadata = {
...
export type __AlefWirePptxMetadata = {
  slide_count: number;
  slide_names: Array<string>;
  image_count?: number | null;
  table_count?: number | null;
};
export type __AlefWireArchiveMetadata = {
  format: string;
  file_count: number;
...
export type __AlefWireImageMetadata = { width: number; height: number; format: string; exif: Record<string, string> };
export type __AlefWireXmlMetadata = { element_count: number; unique_elements: Array<string> };
export type __AlefWireMarkdownLink = { text: string; url: string };
export type __AlefWireMarkdownCodeBlock = { language: string; code: string };
export type __AlefWireTextMetadata = {
  line_count: number;
  word_count: number;
  character_count: number;
  headers?: Array<string> | null;
  links?: Array<__AlefWireMarkdownLink> | null;
  code_blocks?: Array<__AlefWireMarkdownCodeBlock> | null;
};
export type __AlefWireTextDirection = "ltr" | "rtl" | "auto";
export type __AlefWireHeaderMetadata = {
  level: number;
  text: string;
  id?: string | null;
  depth: number;
...
export type __AlefWireLinkType = "anchor" | "internal" | "external" | "email" | "phone" | "other";
export type __AlefWireKeyValueAttribute = { key: string; value: string };
export type __AlefWireLinkMetadata = {
  href: string;
  text: string;
  title?: string | null;
  link_type: __AlefWireLinkType;
  rel: Array<string>;
  attributes: Array<__AlefWireKeyValueAttribute>;
};
export type __AlefWireImageDimensions = { width: number; height: number };
export type __AlefWireImageType = "data-uri" | "inline-svg" | "external" | "relative";
export type __AlefWireImageMetadataType = {
  src: string;
  alt?: string | null;
  title?: string | null;
  dimensions?: __AlefWireImageDimensions | null;
  image_type: __AlefWireImageType;
  attributes: Array<__AlefWireKeyValueAttribute>;
};
export type __AlefWireStructuredDataType = "json-ld" | "microdata" | "rdfa";
export type __AlefWireStructuredData = {
  data_type: __AlefWireStructuredDataType;
  raw_json: string;
  schema_type?: string | null;
};
export type __AlefWireHtmlMetadata = {
  title?: string | null;
  description?: string | null;
  ...
  language?: string | null;
  text_direction?: __AlefWireTextDirection | null;
  open_graph?: Record<string, string>;
  twitter_card?: Record<string, string>;
  meta_tags?: Record<string, string>;
  headers?: Array<__AlefWireHeaderMetadata>;
  links?: Array<__AlefWireLinkMetadata>;
  images?: Array<__AlefWireImageMetadataType>;
  structured_data?: Array<__AlefWireStructuredData>;
};
export type __AlefWireOcrMetadata = {
  language: string;
  psm: number;
...
export type __AlefWireCsvMetadata = {
  row_count: number;
  column_count: number;
...
export type __AlefWireYearRange = { min?: number | null; max?: number | null; years?: Array<number> };
export type __AlefWireBibtexMetadata = {
  entry_count: number;
  citation_keys?: Array<string>;
  authors?: Array<string>;
  year_range?: __AlefWireYearRange | null;
  entry_types?: Record<string, number> | null;
};
export type __AlefWireCitationMetadata = {
...
export type __AlefWireFictionBookMetadata = {
  genres?: Array<string>;
  sequences?: Array<string>;
  annotation?: string | null;
};
export type __AlefWireDbfFieldInfo = { name: string; field_type: string };
export type __AlefWireDbfMetadata = {
  record_count: number;
  field_count: number;
  fields?: Array<__AlefWireDbfFieldInfo>;
};
export type __AlefWireContributorRole = { name: string; role?: string | null };
export type __AlefWireJatsMetadata = {
  copyright?: string | null;
  license?: string | null;
  history_dates?: Record<string, string>;
  contributor_roles?: Array<__AlefWireContributorRole>;
};
export type __AlefWireEpubMetadata = {
  coverage?: string | null;
  dc_format?: string | null;
  relation?: string | null;
  source?: string | null;
  dc_type?: string | null;
  cover_image?: string | null;
};
export type __AlefWirePstMetadata = { message_count: number };
export type __AlefWireAudioMetadata = {
...
export type __AlefWireCodeChunkInfo = {
  text: string;
...
export type __AlefWireCodeDataNodeKind = "key_value" | "element" | "sequence";
export type __AlefWireCodeDataAttribute = { name: string; value: string; byte_start: number; byte_end: number };
export type __AlefWireCodeDataNode = {
  kind: __AlefWireCodeDataNodeKind;
  key?: string | null;
  value?: string | null;
  attributes?: Array<__AlefWireCodeDataAttribute>;
  children?: Array<__AlefWireCodeDataNode>;
  byte_start: number;
  byte_end: number;
};
export type __AlefWireCodeMetadata = { chunks: Array<__AlefWireCodeChunkInfo>; data?: __AlefWireCodeDataNode | null };
