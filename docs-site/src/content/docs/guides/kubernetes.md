...
```bash title="Terminal"
helm install xberg oci://ghcr.io/xberg-io/charts/xberg --version 1.2.4
```
...
```bash title="Terminal"
cosign verify \
  ghcr.io/xberg-io/charts/xberg:1.2.4 \
...
```bash title="Terminal"
helm upgrade xberg oci://ghcr.io/xberg-io/charts/xberg --version 1.2.4 -f values.yaml
