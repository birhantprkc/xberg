...
<!-- alef:hash:dfd8039a806ef95833f71f587806b41793c25433d593c74c4775fe08fd95ef11 -->
...
```bash
zig fetch --save https://github.com/xberg-io/xberg/archive/refs/tags/v1.2.3.tar.gz
```
